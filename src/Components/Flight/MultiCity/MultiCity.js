...
const MultiCity = () => {
  ...
  const extractedFromDateDetails = null;
  ...
  const extractedToDateDetails = null;
      ...
      <div className="w-100%">
        ...
        <div className="flex flex-row mx-[32px] w-[95%] gap-4 mt-5">
          ...
          <div className="flex flex-col gap-4 w-[80%]">
            ...
            <div className="bg-white flex flex-row rounded-lg p-[11px]">
              <div className="flex bg-[#135FA7] py-[28px] w-[50%] text-[20px] justify-center flex-col items-center rounded-lg text-white ">
                <p>
                  New Delhi - Bengaluru <br />
                  Tue, 8 Oct 24 <br /> 08:00 → 11:00
                </p>
              </div>
              <div className="flex flex-col py-[28px] w-[50%] text-[20px] justify-center items-center">
                <p>
                  New Delhi - Bengaluru <br />
                  Tue, 8 Oct 24 <br /> 08:00 → 11:00
                </p>
